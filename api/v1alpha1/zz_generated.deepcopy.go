...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemcachedPools) DeepCopyInto(out *MemcachedPools) {
	*out = *in
	if in.Zones != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemcachedPools.
func (in *MemcachedPools) DeepCopy() *MemcachedPools {
	if in == nil {
		return nil
	}
	out := new(MemcachedPools)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MemcachedPools) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
